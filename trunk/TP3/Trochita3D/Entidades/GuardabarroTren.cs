...
namespace Trochita3D.Core
{
    ...
    {
        public GuardabarroTren(double ancho, double largo, double alto, int cantidadDivisionesAncho, int cantidadDivisionesLargo, int cantidadDivisionesAlto, Punto posicion)
        {
            this.Ancho = ancho;
            this.Alto = alto;
            this.Largo = largo;
